...
router.post('/api/create-payment', function(req, res){
	const orderParams = {
        ...
        redirect_url: encodeURIComponent(`https://api.fitzigaroo.com/paypal/api/redirect_url`),
        cancel_url:encodeURIComponent(`https://api.fitzigaroo.com/paypal/api/redirect_url`),
        language:"EN",
