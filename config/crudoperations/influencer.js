...
const Voucher = require("../schemas/influencerschema");
...
const dbOperations = {
  create: function(voucher, callback) {
    ...
    var Query = {
      influencerId: voucher.influencerId,
      discount: voucher.discount,
      expired: voucher.expired,
      influencerName:voucher.influencerName,
  ...
  checkVoucher: function(voucherId, callback) {
    ...
    Voucher.findOne({ influencerId: voucherId }, function(error, result) {
      if (error) {
        logger.debug(error);
        callback(error, null);
      } else {
  ...
  deleteVoucher: function(voucherId, callback) {
    Voucher.findOne({ influencerId: voucherId }).remove(function(error, result) {
      if (error) {
        logger.debug(error);
